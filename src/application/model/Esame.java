...
public class Esame {
	...
	/**
	 * @return the voto, solo se l'esame è stato superato
	 ...
	 * superato con voto e data specificati.
	 * se invece l'esame era gia superato genera
	 * un'eccezione.
	 * @param voto
	 * @param data
	 */
	public void supera(int voto, LocalDate data){
		if(!this.superato){
			...
			//prb l'esame era gia stato superato
			//eccezione a runtime
